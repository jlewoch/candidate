...
export const getStepsRequest = createAction(types.GET_STEPS_REQUEST)
...
export const addStepRequest = createAction(types.ADD_STEP_REQUEST)
...
export const deleteStepRequest = createAction(types.DELETE_STEP_REQUEST)
...
export const updateStepRequest = createAction(types.UPDATE_STEP_REQUEST)
