...
<Link to='/dashboard' className='app-name'><h1 className='app-name'>CANDIDATE</h1></Link>
</div>
<div className='top-nav__right'>
      <Link className="horizontal-nav-link" to="/dashboard">
        ...
        <Link className={`horizontal-nav-link`} to={`${userinfo.accessLevel < 3 ? '/profile' : '/admin/users'}`}>
