...
export const getPositionsRequest = createAction(types.GET_POSITIONS_REQUEST)
...
export const addPositionRequest = createAction(types.ADD_POSITION_REQUEST)
...
export const deletePositionRequest = createAction(types.DELETE_POSITION_REQUEST)
...
export const updatePositionRequest = createAction(types.UPDATE_POSITION_REQUEST)
